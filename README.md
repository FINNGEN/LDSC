...
### Other inputs
The only other relevant input is the
`  "ldsc_rg.ldsc_args": " '--ref-ld-chr /eur_w_ld_chr/ --w-ld-chr /eur_w_ld_chr/' "`
This string is passed to all `ldsc.py` commands and it determines the reference panel used.
